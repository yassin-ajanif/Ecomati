...
namespace GestionCommerciale.Shared.Database.Migrations
{
    ...
    [Migration("20260918200209_AddImportCalculModule")]
    partial class AddImportCalculModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestionCommerciale.Modules.Charges.Models.ImportCalcul", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<decimal>("TotalMNet")
                        .HasColumnType("TEXT");

                    b.Property<decimal>("TotalTMarge")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("ImportCalculs", (string)null);
                });

            modelBuilder.Entity("GestionCommerciale.Modules.Charges.Models.ImportCalculLigne", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<decimal>("CntColis")
                        .HasColumnType("TEXT");

                    b.Property<decimal>("CntPs")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<int>("ImportCalculId")
                        .HasColumnType("INTEGER");

                    b.Property<decimal>("LaDouane")
                        .HasColumnType("TEXT");

                    b.Property<decimal>("M")
                        .HasColumnType("TEXT");

                    b.Property<decimal>("MNet")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<decimal>("Rmb")
                        .HasColumnType("TEXT");

                    b.Property<decimal>("RmbGrosPrice")
                        .HasColumnType("TEXT");

                    b.Property<decimal>("TMarge")
                        .HasColumnType("TEXT");
                    ...
                    b.HasIndex("ImportCalculId");

                    b.HasIndex("ProduitId");

                    b.ToTable("ImportCalculLignes", (string)null);
                });

            modelBuilder.Entity("GestionCommerciale.Modules.Charges.Models.ImportCalculLigneRmbFrais", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("ImportCalculLigneId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("ImportCalculLigneId");

                    b.ToTable("ImportCalculLigneRmbFrais", (string)null);
                });
            ...
            modelBuilder.Entity("GestionCommerciale.Modules.Charges.Models.ImportCalculLigne", b =>
                {
                    b.HasOne("GestionCommerciale.Modules.Charges.Models.ImportCalcul", "ImportCalcul")
                        .WithMany("Lignes")
                        .HasForeignKey("ImportCalculId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GestionCommerciale.Modules.Charges.Models.ImportCalculLigneRmbFrais", b =>
                {
                    b.HasOne("GestionCommerciale.Modules.Charges.Models.ImportCalculLigne", "Ligne")
                        .WithMany("RmbFrais")
                        .HasForeignKey("ImportCalculLigneId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
